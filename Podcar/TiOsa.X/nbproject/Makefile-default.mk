...
FINAL_IMAGE=dist/${CND_CONF}/${IMAGE_TYPE}/TiOsa.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}
else
...
OBJECTFILES_QUOTED_IF_SPACED=${OBJECTDIR}/_ext/1472/main.o ${OBJECTDIR}/_ext/760475324/xlcd.o ${OBJECTDIR}/_ext/760475324/xlcddelay.o ${OBJECTDIR}/_ext/1360934519/pwm.o ${OBJECTDIR}/_ext/2102461962/usart.o ${OBJECTDIR}/_ext/1472/command.o ${OBJECTDIR}/_ext/1472/myadc.o ${OBJECTDIR}/_ext/1472/sensor.o
POSSIBLE_DEPFILES=${OBJECTDIR}/_ext/1472/main.o.d ${OBJECTDIR}/_ext/760475324/xlcd.o.d ${OBJECTDIR}/_ext/760475324/xlcddelay.o.d ${OBJECTDIR}/_ext/1360934519/pwm.o.d ${OBJECTDIR}/_ext/2102461962/usart.o.d ${OBJECTDIR}/_ext/1472/command.o.d ${OBJECTDIR}/_ext/1472/myadc.o.d ${OBJECTDIR}/_ext/1472/sensor.o.d

# Object Files
OBJECTFILES=${OBJECTDIR}/_ext/1472/main.o ${OBJECTDIR}/_ext/760475324/xlcd.o ${OBJECTDIR}/_ext/760475324/xlcddelay.o ${OBJECTDIR}/_ext/1360934519/pwm.o ${OBJECTDIR}/_ext/2102461962/usart.o ${OBJECTDIR}/_ext/1472/command.o ${OBJECTDIR}/_ext/1472/myadc.o ${OBJECTDIR}/_ext/1472/sensor.o
...
.build-conf:  ${BUILD_SUBPROJECTS}
	${MAKE} ${MAKE_OPTIONS} -f nbproject/Makefile-default.mk dist/${CND_CONF}/${IMAGE_TYPE}/TiOsa.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}
...
${OBJECTDIR}/_ext/1472/command.o: ../command.c  nbproject/Makefile-${CND_CONF}.mk
	...
	${MP_CC} $(MP_EXTRA_CC_PRE) -D__DEBUG  -p$(MP_PROCESSOR_OPTION) -I"../../../../../../Program Files (x86)/Microchip/mplabc18/v3.37.01/h" -I"../osa" -I".." -I"../xlcd" -I"../pwm" -I"../osa/kernel/events" -I"../osa/kernel/timers" -I"../osa/port" -I"../osa/kernel" -I"../osa/port/pic18" -I"../osa/kernel/system" -I"../usart" -ms -oa- -Opa-  -I ${MP_CC_DIR}\\..\\h  -fo ${OBJECTDIR}/_ext/1472/command.o   ../command.c 
	@${DEP_GEN} -d ${OBJECTDIR}/_ext/1472/command.o 
	@${FIXDEPS} "${OBJECTDIR}/_ext/1472/command.o.d" $(SILENT) -rsi ${MP_CC_DIR}../ -c18 
...
${OBJECTDIR}/_ext/1472/sensor.o: ../sensor.c  nbproject/Makefile-${CND_CONF}.mk
	@${MKDIR} ${OBJECTDIR}/_ext/1472 
	@${RM} ${OBJECTDIR}/_ext/1472/sensor.o.d 
	${MP_CC} $(MP_EXTRA_CC_PRE) -D__DEBUG  -p$(MP_PROCESSOR_OPTION) -I"../../../../../../Program Files (x86)/Microchip/mplabc18/v3.37.01/h" -I"../osa" -I".." -I"../xlcd" -I"../pwm" -I"../osa/kernel/events" -I"../osa/kernel/timers" -I"../osa/port" -I"../osa/kernel" -I"../osa/port/pic18" -I"../osa/kernel/system" -I"../usart" -ms -oa- -Opa-  -I ${MP_CC_DIR}\\..\\h  -fo ${OBJECTDIR}/_ext/1472/sensor.o   ../sensor.c 
	@${DEP_GEN} -d ${OBJECTDIR}/_ext/1472/sensor.o 
	@${FIXDEPS} "${OBJECTDIR}/_ext/1472/sensor.o.d" $(SILENT) -rsi ${MP_CC_DIR}../ -c18 
...
${OBJECTDIR}/_ext/1472/command.o: ../command.c  nbproject/Makefile-${CND_CONF}.mk
	@${MKDIR} ${OBJECTDIR}/_ext/1472 
	@${RM} ${OBJECTDIR}/_ext/1472/command.o.d 
	${MP_CC} $(MP_EXTRA_CC_PRE) -p$(MP_PROCESSOR_OPTION) -I"../../../../../../Program Files (x86)/Microchip/mplabc18/v3.37.01/h" -I"../osa" -I".." -I"../xlcd" -I"../pwm" -I"../osa/kernel/events" -I"../osa/kernel/timers" -I"../osa/port" -I"../osa/kernel" -I"../osa/port/pic18" -I"../osa/kernel/system" -I"../usart" -ms -oa- -Opa-  -I ${MP_CC_DIR}\\..\\h  -fo ${OBJECTDIR}/_ext/1472/command.o   ../command.c 
	@${DEP_GEN} -d ${OBJECTDIR}/_ext/1472/command.o 
	@${FIXDEPS} "${OBJECTDIR}/_ext/1472/command.o.d" $(SILENT) -rsi ${MP_CC_DIR}../ -c18 
...
${OBJECTDIR}/_ext/1472/sensor.o: ../sensor.c  nbproject/Makefile-${CND_CONF}.mk
	@${MKDIR} ${OBJECTDIR}/_ext/1472 
	@${RM} ${OBJECTDIR}/_ext/1472/sensor.o.d 
	${MP_CC} $(MP_EXTRA_CC_PRE) -p$(MP_PROCESSOR_OPTION) -I"../../../../../../Program Files (x86)/Microchip/mplabc18/v3.37.01/h" -I"../osa" -I".." -I"../xlcd" -I"../pwm" -I"../osa/kernel/events" -I"../osa/kernel/timers" -I"../osa/port" -I"../osa/kernel" -I"../osa/port/pic18" -I"../osa/kernel/system" -I"../usart" -ms -oa- -Opa-  -I ${MP_CC_DIR}\\..\\h  -fo ${OBJECTDIR}/_ext/1472/sensor.o   ../sensor.c 
	@${DEP_GEN} -d ${OBJECTDIR}/_ext/1472/sensor.o 
	@${FIXDEPS} "${OBJECTDIR}/_ext/1472/sensor.o.d" $(SILENT) -rsi ${MP_CC_DIR}../ -c18 
